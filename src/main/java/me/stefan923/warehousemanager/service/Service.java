...
import me.stefan923.warehousemanager.service.validator.Validator;
import me.stefan923.warehousemanager.repository.Repository;
...
public abstract class Service<T> {
    ...
    protected final Repository<T> dao;

    private final List<Validator<T>> validators;

    public Service(List<Validator<T>> validators, Repository<T> dao) {
